package com.example.googlemapmarkercustom;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener, GoogleMap.OnMapClickListener {
    ...
    private void setCustomMarkerView() {
        ...
        textView=(TextView)marker_root_view.findViewById(R.id.textm);
    }
    ...
    private Marker addMarker(MarkerItem markerItem, boolean isSelectedMarker) {
        ...
        textView.setText("바보");
        if (isSelectedMarker) {
            tv_marker.setBackgroundResource(R.drawable.marker2_custom);
            tv_marker.setTextColor(Color.WHITE);
            marker_root_view.setBackgroundResource(R.drawable.marker1_custom);
        } else {
            tv_marker.setBackgroundResource(R.drawable.marker1_custom);
            tv_marker.setTextColor(Color.BLACK);
            marker_root_view.setBackgroundResource(R.drawable.marker2_custom);
        }
